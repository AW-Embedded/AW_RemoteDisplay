...
const uint16_t BITMAP_BLUELED_ID = 3;
const uint16_t BITMAP_CONFIGURATION_ID = 4;
const uint16_t BITMAP_DARK_BUTTONS_ROUND_ICON_BUTTON_ID = 5;
const uint16_t BITMAP_DARK_BUTTONS_ROUND_ICON_BUTTON_PRESSED_ID = 6;
const uint16_t BITMAP_GREENLED_ID = 7;
const uint16_t BITMAP_ORANGELED_ID = 8;
const uint16_t BITMAP_REDLED_ID = 9;
const uint16_t BITMAP_YELLOWLED_ID = 10;
